...
for snr = -20 : 1 : 0  
    ...
    success_rate = [success_rate, 1 - n_failed/n_runs] % Erfolgsquote
end
...
if plot_ber == 1
    figure();
    plot(-20:1:0, success_rate); title('Erfolgsquote der Frequenzsynchronisation');
    xlabel('SNR'); ylabel('Erfolgsquote');
end
