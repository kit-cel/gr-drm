...
# Generated: Mon Aug  8 17:40:06 2016
##################################################
...
class drm_mlc_64qam_sm_bc(gr.hier_block2):

    def __init__(self, vlen_in=1, n_tailbits=1, denom_mother_code_rate=1, gen_poly=0, vlen_out=1, bits_per_symbol=1, map_tab=0, pp_0=0, pp_0_tail=0, pp_1=0, pp_1_tail=0, pp_2=0, pp_2_tail=0, interl_seq_0_2=(0,1), interl_seq_2_2=(0,1), interl_seq_1_2=(0,1), M_total=0, part_len_bot=3, part_len_top=3, part_len_mid=3):
        ...
        self.pp_2 = pp_2
        self.pp_2_tail = pp_2_tail
        self.interl_seq_0_2 = interl_seq_0_2
        self.interl_seq_2_2 = interl_seq_2_2
        self.interl_seq_1_2 = interl_seq_1_2
        self.M_total = M_total
        self.part_len_bot = part_len_bot
        self.part_len_top = part_len_top
        self.part_len_mid = part_len_mid

        ##################################################
        # Blocks
        ##################################################
        self.trellis_encoder_xx_top_0 =  trellis.encoder_bb(trellis.fsm(1, denom_mother_code_rate, gen_poly), 0, 0) if False else trellis.encoder_bb(trellis.fsm(1, denom_mother_code_rate, gen_poly), 0) 
        ...
        self.drm_qam_map_bc_0 = drm.qam_map_bc(map_tab, bits_per_symbol, vlen_out, 3)
        ...
        self.drm_punct_bb_mid = drm.punct_bb(pp_1, pp_1_tail, (part_len_mid+ n_tailbits) * denom_mother_code_rate, vlen_out * 2, n_tailbits * denom_mother_code_rate)
        self.drm_punct_bb_bot = drm.punct_bb(pp_2, pp_2_tail, (part_len_bot + n_tailbits) * denom_mother_code_rate, vlen_out * 2, n_tailbits * denom_mother_code_rate)
        self.drm_partitioning_64sm_bb_0 = drm.partitioning_bb(vlen_in, M_total)
        self.drm_interleaver_bb_mid = drm.interleaver_bb(((interl_seq_1_2)))
        self.drm_interleaver_bb_bot = drm.interleaver_bb(((interl_seq_2_2)))
        self.drm_add_tailbits_bb_top_0 = drm.add_tailbits_bb(part_len_mid, n_tailbits)
        ...
        self.blocks_unpack_k_bits_bb_mid = blocks.unpack_k_bits_bb(denom_mother_code_rate)
        ...
        self.connect((self.blocks_unpack_k_bits_bb_mid, 0), (self.drm_punct_bb_mid, 0))    
        ...
        self.connect((self.drm_add_tailbits_bb_top_0, 0), (self.trellis_encoder_xx_top_0, 0))    
        self.connect((self.drm_interleaver_bb_bot, 0), (self.drm_qam_map_bc_0, 2))    
        self.connect((self.drm_interleaver_bb_mid, 0), (self.drm_qam_map_bc_0, 1))    
        self.connect((self.drm_partitioning_64sm_bb_0, 2), (self.drm_add_tailbits_bb_bot, 0))    
        self.connect((self.drm_partitioning_64sm_bb_0, 0), (self.drm_add_tailbits_bb_top, 0))    
        self.connect((self.drm_partitioning_64sm_bb_0, 1), (self.drm_add_tailbits_bb_top_0, 0))    
        self.connect((self.drm_punct_bb_bot, 0), (self.drm_interleaver_bb_bot, 0))    
        self.connect((self.drm_punct_bb_mid, 0), (self.drm_interleaver_bb_mid, 0))    
        self.connect((self.drm_punct_bb_top, 0), (self.drm_qam_map_bc_0, 0))    
        self.connect((self.drm_qam_map_bc_0, 0), (self, 0))    
        self.connect((self, 0), (self.drm_partitioning_64sm_bb_0, 0))    
        ...
        self.connect((self.trellis_encoder_xx_top_0, 0), (self.blocks_unpack_k_bits_bb_mid, 0))    
    ...
    def set_pp_2(self, pp_2):
        self.pp_2 = pp_2

    def get_pp_2_tail(self):
        return self.pp_2_tail

    def set_pp_2_tail(self, pp_2_tail):
        self.pp_2_tail = pp_2_tail
    ...
    def get_interl_seq_2_2(self):
        return self.interl_seq_2_2

    def set_interl_seq_2_2(self, interl_seq_2_2):
        self.interl_seq_2_2 = interl_seq_2_2
    ...
    def get_part_len_mid(self):
        return self.part_len_mid

    def set_part_len_mid(self, part_len_mid):
        self.part_len_mid = part_len_mid
